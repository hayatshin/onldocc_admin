...
class WeekRankingViewModel extends AsyncNotifier<List<UserModel?>> {
...
final weekRankingProvider =
    AsyncNotifierProvider<WeekRankingViewModel, List<UserModel?>>(
  () => WeekRankingViewModel(),
);
